...
import { Users, Briefcase, BarChart3, ArrowRight, Clock, TrendingUp, Zap, ChevronRight } from 'lucide-react'

// Compact horizontal pipeline — 8 nodes in a single row with arrows
      ...
      {PIPELINE_STEPS.map((step, i) => {
        ...
        return (
          <div key={step.label} className="flex items-center flex-shrink-0">
            ...
            >
              {/* Dot indicator top */}
              <div className="w-1.5 h-1.5 rounded-full mb-2 transition-all duration-300"
                style={{
              ...
              <div
                ...
                style={{
                  background: isActive
                    ? `linear-gradient(135deg, ${step.color}22, ${step.color}0D)`
                    : isPast
              ...
              >
                <div style={{
                  ...
                  fontWeight: 700,
                  fontSize: 10,
                  color: isActive ? step.color : isPast ? step.color + 'AA' : 'rgba(200,200,230,0.35)',
                  lineHeight: 1.2,
                  marginBottom: 3,
                }}>
                  {step.label}
                ...
                <div style={{
                  ...
                  fontSize: 8,
                  color: isActive ? 'rgba(220,220,255,0.65)' : 'rgba(150,150,190,0.3)',
                  lineHeight: 1.3,
                }}>
                  {step.desc}
                </div>
              ...
              <div className="mt-2" style={{
                fontFamily: 'JetBrains Mono, monospace',
                fontSize: 8,
                color: isActive ? step.color : 'rgba(255,255,255,0.12)',
                letterSpacing: '0.1em',
              }}>
            ...
            {i < PIPELINE_STEPS.length - 1 && (
              <div className="flex items-center mx-0.5 flex-shrink-0" style={{ marginTop: -16 }}>
                <div style={{
                  ...
                  height: 1,
                  background: i < active
                    ? `linear-gradient(90deg, ${PIPELINE_STEPS[i].color}60, ${PIPELINE_STEPS[i+1].color}60)`
...
function StatCard({ label, value, icon: Icon, color, delta }) {
  return (
    <div className="relative rounded-2xl p-5 overflow-hidden" style={{
      ...
      <div style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 800, fontSize: 34, color: '#cbcbd5', lineHeight: 1 }}>
        {value}
      </div>
  ...
  return (
    <div className="p-8 min-h-screen max-w-5xl mx-auto">
      ...
      <div className="mb-10 flex items-end justify-between">
        <div>
          ...
          <h1 style={{
            ...
            lineHeight: 1.05, color: '#a4a4cb', letterSpacing: '-0.02em', marginBottom: 10,
          }}>
          ...
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 14, color: 'rgba(140,140,180,0.65)', maxWidth: 400, lineHeight: 1.65 }}>
            8-agent AI pipeline that scores, ranks, and explains every candidate in seconds.
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        <StatCard label="Jobs Uploaded"     value={stats.jobs}        icon={Briefcase} color="#6C63FF" delta="+2 this week" />
        <StatCard label="Candidates Parsed" value={stats.candidates}  icon={Users}     color="#10B981" delta="+18%" />
        <StatCard label="Evaluations Run"   value={stats.evaluations} icon={BarChart3} color="#F59E0B" delta="+24%" />
      </div>
        ...
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 12, color: 'rgba(108,99,255,0.5)', marginTop: 2, letterSpacing: '0.08em' }}>
              8-agent LangGraph DAG · live flow
            </p>
          </div>
